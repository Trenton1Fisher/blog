  ...
  return (
    <div className="w-full py-5 bg-tertiary mt-10">
      <div className="w-[95%] mx-auto max-w-[1450px]">
        <div className="py-5 border-b border-gray-300 border-opacity-29 flex justify-between items-center max-md:flex-col max-md:gap-8">
        ...
        <div className="w-full text-center mt-3 text-sm text-white">
          {' '}
          <span>All Rights Reserved Blog T</span>
        </div>
      </div>
    </div>
  )
